...
public class Performance : MonoBehaviour
{
...
#endif
            appdomain.Invoke("HotFix.TestPerformance", testName, null, sb);
    ...
    IEnumerator LoadHotFixAssembly()
    {
        ...
        //工程目录在Assets\ThirdParty\ILRuntime\1.6\Demo\HotFix_Project~
        ...
        {
            Debug.LogError("加载热更DLL失败，请确保已经通过VS打开Assets/ThirdParty/ILRuntime/2.0.2/Demo/HotFix_Project/HotFix_Project.sln编译过热更DLL");
        }
