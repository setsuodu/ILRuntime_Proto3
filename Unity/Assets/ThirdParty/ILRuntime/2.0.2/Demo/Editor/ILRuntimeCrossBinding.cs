...
public class ILRuntimeCrossBinding
{
   [MenuItem("ILRuntime/生成跨域继承适配器")]
    static void GenerateCrossbindAdapter()
    {
        ...
        using(System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/ThirdParty/ILRuntime/2.0.2/Demo/Scripts/Examples/04_Inheritance/InheritanceAdapter.cs"))
        {
