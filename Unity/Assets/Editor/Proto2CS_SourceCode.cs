...
public static class InnerProto2CS
{
    ...
    private const string clientMessagePath = "../ILRuntimeDemo/Assets/ThirdParty/Message/";
    ...
    public static void Proto2CS()
    {
        ...
        Proto2CS("ET", "../Proto/MongoMessage.proto", serverMessagePath, "MongoOpcode", MongoMinOpcode);
        ...
        */
        Proto2CS("ET", "../Proto/OuterMessage.proto", clientMessagePath, "OuterOpcode", OuterMinOpcode);
        //Proto2CS("ET", "../Proto/TheMsg.proto", clientMessagePath, "TheMsgOpcode", OuterMinOpcode);
