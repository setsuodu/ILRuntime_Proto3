...
namespace Client
{
    public class ILWidget : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //var script = gameObject.AddComponent<T>();
            OnHotFixLoaded();
        }
        ...
        IEnumerator LoadHotFixAssembly()
        {
            ...
            // 使用 TextAssets 读取 dll 的 assetBundle
            yield return null;
            //byte[] dll = AssetBundleManager.instance.AssetBundleDll();
        ...
        {
            SetupCLRRedirection();
            appdomain.Invoke("HotFix.Main", className, null, gameObject);
        }
